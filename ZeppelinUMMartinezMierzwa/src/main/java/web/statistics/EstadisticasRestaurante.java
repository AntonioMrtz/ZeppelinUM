...
@Named
@RequestScoped
public class EstadisticasRestaurante implements Serializable {
    ...
    public void createBarModel() {
        ...
        title.setText("Número de pedidos del restaurante frente al total de pedidos");
    ...
    public void createBarModel2() {
        ...
        Title title = new Title();
        title.setDisplay(true);
        title.setText("Número de usuarios que han pedido al restaurante vs usuarios totales");
        options.setTitle(title);
